...
PARAM  <- list()
PARAM$experimento <- "TS9320_TRAINING20192021_EXP1"
...
PARAM$final_train  <- c( 201905,201906,201907,201908,201909,201910,201911,201912, 202011, 202012, 202101, 202102, 202103,202104)

PARAM$train$training     <- c( 201904,201905,201906,201907,201908,201909,201910,201911,201912, 202011, 202012, 202101, 202102, 202103)
