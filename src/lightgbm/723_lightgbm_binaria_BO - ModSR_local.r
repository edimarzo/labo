...
hs <- makeParamSet( 
         ...
         #makeIntegerParam("max_bin",          lower= 10   , upper= 200),
...
PARAM$hyperparametertuning$semilla_azar  <- 775163  #Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy
...
setwd("E:/Exe/FCEN/NextCloud/Documents/Maestría/DMEyF")   #Establezco el Working Directory

#cargo el dataset donde voy a entrenar el modelo
dataset  <- fread( PARAM$input$dataset )


#modificacion de Dataset
