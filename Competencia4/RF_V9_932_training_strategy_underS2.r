...
PARAM  <- list()
PARAM$experimento <- "TS9320_RF_R0_L36_T36_S9"

PARAM$exp_input  <- "FE9250_RF_R0_L36_T36"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 201909,201910,201911,201912, 202011,202012,202101,202102,202103,202104,202105,202106 )

PARAM$train$training     <- c( 201908,201909,201910,201911,201912, 202011,202012,202101,202102,202103,202104,202105)
...
PARAM$train$semilla_sampling  <- 669989
PARAM$train$semilla_under     <- 669989
