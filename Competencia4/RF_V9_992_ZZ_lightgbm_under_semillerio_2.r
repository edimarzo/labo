...
PARAM <- list()
PARAM$experimento <- "ZZ9410_semillerio_ensamble_m2"
PARAM$exp_input <- "HT9420_RF_R0_L36_T36_S9"

# PARAM$modelos  <- 2
PARAM$modelo <- 1 # se usa el mejor de la OB, pero a futuro podria variar esto
PARAM$semilla_primos <- 472993
PARAM$semillerio <- 5 # ¿De cuanto será nuestro semillerio?
